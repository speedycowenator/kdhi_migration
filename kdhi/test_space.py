...
four_pages 	= ['One', 'Two', 'Three', 'Four']#, 'Five', 'Six']
pulled_article_titles = []
codes_list = []
...
for code in codes_list:
	...
	if date == now:
		pulled_article_titles.append(title)
		
	else:
		pass

log_name = "test_kcna_titles.txt"

f = open(log_name,"w+")
for article_title in pulled_article_titles:
